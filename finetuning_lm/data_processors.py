...
class TSVDataProcessor(DatasetProcessor):
    ...
    def get_train_examples(self):
        ...
        return self._create_examples(
            self._read_tsv(os.path.join(self.data_dir, "BERT_2016_finetune_train.tsv")), "train")

    def get_dev_examples(self):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(self.data_dir, "BERT_2016_finetune_eval.tsv")), "dev")
    ...
    def get_labels(self, task_name):
        ...
        labels = set()
        with open(os.path.join(self.data_dir, "BERT_2016_finetune_train.tsv"), "r") as in_file:
            for line in in_file:
