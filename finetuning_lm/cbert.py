...
def main():
    ...
    parser.add_argument("--output_dir", default="test_dir", type=str,
...
def augment_train_data(model, tokenizer, train_data, label_list, args):
    ...
    best_model_path = os.path.join("finetuned_model/CBERT", "best_cbert.pt")
    if os.path.exists(best_model_path):
        model.load_state_dict(torch.load("HAABSA_Plus_Plus_Selective_DA/data/programGeneratedData/finetuning_data/_finetune_model/CBERT/best_cbert.pt", 
